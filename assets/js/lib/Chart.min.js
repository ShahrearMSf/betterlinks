...
!(function (t, e) {
			...
			(a.rgb.hsl = function (t) {
				...
				(a.rgb.hcg = function (t) {
					var e,
						...
						s = r - o;
					return (
						(e = s <= 0 ? 0 : r === n ? ((i - a) / s) % 6 : r === i ? 2 + (a - n) / s : 4 + (n - i) / s + 4), (e /= 6), [360 * (e %= 1), 100 * s, 100 * (s < 1 ? o / (1 - s) : 0)]
					);
				}),
	...
	(y.prototype = {
		...
		clone: function () {
			...
			for (var r in i)
				i.hasOwnProperty(r) &&
					((t = i[r]), '[object Array]' === (e = {}.toString.call(t)) ? (a[r] = t.slice(0)) : '[object Number]' === e ? (a[r] = t) : console.error('unexpected color value:', t));
			return n;
		},
	}),
		(y.prototype.spaces = {
					...
					for (t = 0, e = l.length; t < e; ++t)
						(n = l[t]._model),
							Ht(n, s) &&
								(t > 0 &&
									Ht(l[t - 1]._model, s) &&
									((n.controlPointPreviousX = u(n.controlPointPreviousX, s.left, s.right)), (n.controlPointPreviousY = u(n.controlPointPreviousY, s.top, s.bottom))),
								t < l.length - 1 &&
									Ht(l[t + 1]._model, s) &&
	...
	var qe = K.extend({
			...
			getCaretPosition: function (t, e, n) {
				...
				if ('center' === c) (s = g + m / 2), 'left' === h ? ((a = (i = f) - u), (r = i), (o = s + u), (l = s - u)) : ((a = (i = f + p) + u), (r = i), (o = s - u), (l = s + u));
					...
					('left' === h ? ((i = (a = f + d + u) - u), (r = a + u)) : 'right' === h ? ((i = (a = f + p - d - u) - u), (r = a + u)) : ((i = (a = n.caretX) - u), (r = a + u)),
					'top' === c)
				)
					(s = (o = g) - u), (l = o);
				else {
	...
	function hn(t, e, n) {
		...
		if (
			!(
				n &&
				((i = 1 === a ? Math.max(o - s, l - o) : 0 === e ? (t.getPixelForTick(1) - o) / 2 : (o - t.getPixelForTick(r - 1)) / 2), (o += r < e ? i : -i) < s - 1e-6 || o > l + 1e-6)
			)
		)
			return o;
	}
	...
	var zn = yn.extend({
			...
			handleTickRangeOptions: function () {
				...
				(t.min = Rn(e.min, t.min)),
					...
					t.min === t.max &&
						(0 !== t.min && null !== t.min ? ((t.min = Math.pow(10, Math.floor(On(t.min)) - 1)), (t.max = Math.pow(10, Math.floor(On(t.max)) + 1))) : ((t.min = 1), (t.max = 10))),
