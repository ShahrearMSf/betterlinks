!(function (e, t) {
	...
	function Ae(e, t, n) {
		...
		return (
			a < 1 ? (s = a + je((i = e.year() - 1), t, n)) : a > je(e.year(), t, n) ? ((s = a - je(e.year(), t, n)), (i = e.year() + 1)) : ((i = e.year()), (s = a)), { week: s, year: i }
		);
	}
	function je(e, t, n) {
		var s = Ge(e, t, n),
	...
	function lt(e, t) {
		var n;
		return (
			e && ((n = r(t) ? dt(e) : ht(e, t)) ? (nt = n) : 'undefined' != typeof console && console.warn && console.warn('Locale ' + e + ' not found. Did you forget to load it?')),
			nt._abbr
		);
	}
	function ht(e, t) {
	...
	function Gt(e, t) {
		var n, s;
		return t._isUTC
			? ((n = t.clone()), (s = (M(e) || a(e) ? e.valueOf() : Tt(e).valueOf()) - n.valueOf()), n._d.setTime(n._d.valueOf() + s), f.updateOffset(n, !1), n)
			: Tt(e).local();
	}
	function Et(e) {
	...
	function $t(e, t) {
		var n = {};
		return (
			(n.months = t.month() - e.month() + 12 * (t.year() - e.year())), e.clone().add(n.months, 'M').isAfter(t) && --n.months, (n.milliseconds = t - e.clone().add(n.months, 'M')), n
		);
	}
	function qt(s, i) {
		return function (e, t) {
	...
	(pn.add = Jt),
		...
		(pn.parseZone = function () {
			var e;
			return (
				null != this._tzm ? this.utcOffset(this._tzm, !1, !0) : 'string' == typeof this._i && (null != (e = Vt(le, this._i)) ? this.utcOffset(e) : this.utcOffset(0, !0)), this
			);
		}),
