...
const modules = {
	toolbar: [['bold', 'italic', 'underline', 'strike', 'blockquote'], [{ header: '1' }, { header: '2' }], [{ list: 'ordered' }, { list: 'bullet' }], ['link', 'image'], ['clean']],
};
			...
			<div className="btl-form-field">
				<label className="btl-checkbox-field block">
					<div className="btl-affiliate-disclosure-editor">
						<ReactQuill theme={theme} onChange={handleChange} value={html} modules={modules} formats={formats} placeholder={'Type here...'} />
					</div>
