...
class Clicks extends Controller
{
	...
	public function get_value($request)
	{
		...
		from {$prefix}betterlinks_clicks as CLICKS left join {$prefix}betterlinks on {$prefix}betterlinks.id = CLICKS.link_id WHERE created_at BETWEEN '{$from} 00:00:00' AND '{$to} 23:59:00' group by CLICKS.id")->get();
