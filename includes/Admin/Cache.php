...
class Cache {
	...
	public static function write_json_settings() {
		...
		// Using file_put_contents is like opening a file, writing to it, and then closing it. Sometimes, it might show warnings because of cache files, so it's better to silence the warning.
