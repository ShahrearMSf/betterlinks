...
class Link extends Utils
{
    ...
    public function run_redirect()
    {
        ...
        if (empty($data['target_url']) || !apply_filters('betterlinks/pre_before_redirect', $data)) {
            if( apply_filters('betterlinks/is_password_protected_redirect_compatible', false) ){
                ...
                if( $referer_short_url === $short_url ) return false;
                ...
                if( $is_active_cookie ) return false;
            }

            if (empty($data['target_url']) || !apply_filters('betterlinks/pre_before_redirect', $data)) return false;
        }
