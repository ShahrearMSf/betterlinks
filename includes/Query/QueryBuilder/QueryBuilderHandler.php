...
class QueryBuilderHandler
{
    ...
    public function __construct(Connection $connection = null)
    {
        ...
        $this->adapterInstance = $this->container->build(
            '\\BetterLinks\\Query\\QueryBuilder\\Adapters\\' . ucfirst($this->adapter),
    ...
    public function join($table, $key, $operator = null, $value = null, $type = 'inner')
    {
        ...
        $joinBuilder = $this->container->build('\\BetterLinks\\Query\\QueryBuilder\\JoinBuilder', array($this->connection));
    ...
    {
        return $this->container->build('\\BetterLinks\\Query\\QueryBuilder\\Raw', array($value, $bindings));
    }
